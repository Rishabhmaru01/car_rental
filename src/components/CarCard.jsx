  ...
  return (
    ...
    className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
        ...
        <div className='relative h-48 overflow-hidden'>
          ...
          {car.isAvaliable && <p className='absolute top-4 left-4 text-white bg-blue-500 text-xs px-2.5 py-1 rounded-full'>Available Now</p> }
        ...
        <div className='p-4 sm:p-5'>
          ...
          <div className='m-4 grid grid-cols-2 gap-y-2 text-gray-600'>
