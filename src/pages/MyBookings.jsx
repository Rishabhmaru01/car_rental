...
const MyBookings = () => {
  ...
  return (
    <div className='px6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-2-7xl'>
          ...
          <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border borderColor rounded-lg mt-5 first:mt-12'>
            ...
            <div className='md:col-span-2'>
              <div className='flex items-center gap-2'>
                <p className='px-3 py2 bg-blue-200 rounded'>Booking #{index+1}</p>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  <p className='text-gray-400'>Retal Period</p>
            ...
            <div className='md:col-span-1 flex flex-col justify-between gap-6'>
              <div className='text-sm text-gray-500 text-right'>
                <p>Total Price</p>
                <h1 className='text-2xl font-semibold text-blue-400'>{currency}{booking.price}</h1>
