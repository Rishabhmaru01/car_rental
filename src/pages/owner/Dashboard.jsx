...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title='Admin Dashboard' subTitle='Monitar overall plateform performance including total cars, booking, revenure and recent activities'/>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
          ...
          {data.recentBookings.map((booking,index)=>(
            <div key={index} className='flex justify-between items-center mt-4'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p>{booking.car.bramd} {booking.car.model}</p>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          ...
          <p className='text-3xl mt-6 font-semibold text-blue-500'>{currency}{data.monthlyRevenue}</p>
        </div>
      </div>
