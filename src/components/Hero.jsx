    ...
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-gray-100 text-center'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-10 md:ml-8'>
                ...
                <button className='flex items-center justify-center gap-1 px-7 py-3 max-sm:mt-4 bg-blue-500 hover:bg-blue-300 text-white rounded-full'>
        ...
        <img src={assets.main_car} alt="car img" className='max-h-74' />
