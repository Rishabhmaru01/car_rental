  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image) : user?.image || "https://unsplash.com/photos/smiling-man-standing-near-green-tree-MTZTGvDsHFY"} alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'/>
        ...
        {image && (
            <button className='absolute top-0 right-0 flex p-2 gap-1 bg-blue-400/10 text-blue-600 cursor-pointer'>Save<img src={assets.check_icon} width={15} alt=""  
